...
## Agenda Item 1: Setting up Iteration 3
...
## Agenda Item 2: Risk Register

**Presenter: Marshall Lampitt** 

### Discussion
We will need to research the risk register. Discuss the risks involved in the project. Set our goals. Decide on our out of class time to work on the risk register.
We need to look at scheduling, attendence, resources, connection issues, etc.
...
## Agenda Item 3: Image processing
...
- Complete weekly task (uploading images for website)
...
Wednesday 6th of May , either in class or at 12:15pm.
